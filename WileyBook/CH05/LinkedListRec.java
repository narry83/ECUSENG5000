...
public class LinkedListRec<E> {
    ...
    /**
     * Method to search a LinkedListRec to see if an item is contained
     * in it.
     ...
     * @return A LinkedListRec object that contains the same contents
     *         of this list with the elements reversed.
     */
    public LinkedListRec<E> reverse() {
        LinkedListRec<E> result = new LinkedListRec<>();
    ...
    /**
     * Method to reverse the elements in a linked list
     * @param head The current node in the list being reversed
     *  @param newHead The head of the reversed list
     * @return The head of a LinkedListRec object that contains the same contents
     *         of this list with the elements reversed.
     */
    private Node<E> reverse(Node<E> head, Node<E> newHead) {
        ...
        return reverse(head.next, new Node<>(head.data, newHead));
    }
    /*</exercise>*/
    ...
    /**
     * Method to remove an item at a specified index
     * @param pred the node before the item at the current indes
     * @param index the current index
     */
