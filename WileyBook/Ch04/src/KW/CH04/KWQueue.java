...
public class KWQueue<E> implements Queue<E> {
    ...
    // Data Field
    private final LinkedList<E> theQueue = new LinkedList<>(); // LinkedList that is the queue.
    ...
    /**
     * Retrievs, but does not remove the entry at the front of the queue
     * and returns it.
    ...
    /**
     * Retains only those elements in this queue that
    ...
    /**
     * Removes those elements in this queue that
     * are contained in the specified collection
     * @param c the specified collection
     * @return true if this queue changed
     */
    ...
    /**
     * Returns true if this queue contains all items in the specified
     * collection
     * @param c the specified collection
     ...
     * array.  If the queue fits in the specified array, it is the
     * returned item. If there is room to spare the element immediately
