...
public class ParenChecker {
	...
	/**
	 * Test the input string to see that it contains balanced parentheses. This
	 * method tests an input string to see that each type of parenthesis is
	 * balanced. '(' is matched with ')', '[' is matched with ']', and '{' is
	 * matched with '}'.
	 * 
