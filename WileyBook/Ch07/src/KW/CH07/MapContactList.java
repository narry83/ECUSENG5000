...
public class MapContactList implements ContactListInterface {
	...
	/** The contact list */
	private final Map<String, List<String>> contacts = new TreeMap<>();
	 ...
	 * @return The current list of numbers. If not in directory, null is returned
	 */
	@Override
	...
	public static void main(String[] args) {
		...
		System.out.println("Numbers for Jones " + contactList.lookupEntry("Jones"));
		// Smith should not
		System.out.println("Numbers for Smith " + contactList.lookupEntry("Smith"));
